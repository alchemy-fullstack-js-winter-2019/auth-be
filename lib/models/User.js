...
// The password passed to the function is the same as the value passed to the password key
...
// method applies to instance of class 'user'
userSchema.methods.compare = function(password) {
  return compare(password, this.passwordHash);
};

// statics apply to class 'User'
